...
<body>
    ...
    <div>
        <form:form method="POST" modelAttribute="course" name = "courseForm">
            <%--Department:<form:input path="department" /><br>--%>
            <%--Number:<form:input path="number" /><br>--%>
            Name:<form:input path="name" /><br>
            Credit:<form:input path="credit" /><br>
            Description:<form:textarea path="description" style="height:100px;width:300px;"/><br>
